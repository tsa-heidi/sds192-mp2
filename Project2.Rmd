...
# Functions
Creating a function to generalize our wrangling
...
Therefore, we decided to further our analysis by faceting our initial graphs by whether the candidate was an incumbent or not. It appears that if you are an incumbent, you are more likely to get larger donations (see NYR/Dplot2, CARplot2, TXRplot2), but not necessarily win. Similarly, if you are an incumbent, it seems you will win even if you have a smaller amount in contributions (see NYD/Rplot2, TXRplot2, CADplot2). This result could be explained by the fact that incumbents are more established and therefore donations matter less. Furthermore, if you are not an incumbent, it seems that the more donations you have, the more likely you are to win as the blue bars are longer for non-incumbents who won (see NYDplot2, CADplot2, TXDplot2)
